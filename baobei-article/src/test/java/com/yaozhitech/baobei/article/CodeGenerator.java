package com.yaozhitech.baobei.article;

import com.google.common.base.CaseFormat;
import com.yaozhitech.baobei.article.constants.ProjectConstant;
...
public class CodeGenerator {
    /** JDBC配置，请修改为你项目的实际配置 */
    private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/mysql?useSSL=false";
    ...
    public static void main(String[] args) {
         ...
         * 元素4: 主键数据类型 [不可为空，用数据包装类型，默认Integer]
         */
